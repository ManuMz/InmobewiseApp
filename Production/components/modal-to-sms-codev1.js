        ...
        initrecapcha()
        {
          ...
          async getresponsecode()
          {
             ...
             try {
               ...
               */
                let services ="https://arvispace.com/serviciosASAR/validarCorreoLogin.php";
               ...
               //alert("respuesta: "+JSON.stringify(respuestaregister));
                let resp=respuestaregister.data;
                   //alert("ultima respuesta: "+JSON.stringify(resp));
               ...
               //2461375273
                //setTimeout(function() {   this.$emit('close-sms') }.bind(this), 1500);//este regresa al ar-anim.js

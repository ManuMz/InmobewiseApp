...
var register = {
  ...
  }, _defineProperty(_components, "rounded-button", roundedButton), _defineProperty(_components, "component-form", componentForm), _components),
  data: function data() {
    return {
      buttonHeaderUser: {
  ...
  watch: {
    "formDefaultData.input_nombre.value": function formDefaultDataInput_nombreValue(newValue, oldValue) {
      var field = this.formSchema.fields.filter(function (x) {
        return x.name == "input_nombre";
      });
    ...
    "formDefaultData.input_apodo.value": function formDefaultDataInput_apodoValue(newValue, oldValue) {
      var field = this.formSchema.fields.filter(function (x) {
        return x.name == "input_apodo";
      });
      var res = field[0].validation(newValue);
      this.formDefaultData.input_apodo.error.isActive = !res.isValid;
      this.formDefaultData.input_apodo.error.message = res.msg;
    },
    "formDefaultData.input_email.value": function formDefaultDataInput_emailValue(newValue, oldValue) {
      var field = this.formSchema.fields.filter(function (x) {
        return x.name == "input_email";
      });
      var res = field[0].validation(newValue);
    ...
    "formDefaultData.input_r_password.value": function formDefaultDataInput_r_passwordValue(newValue, oldValue) {
      var field = this.formSchema.fields.filter(function (x) {
    ...
    "formDefaultData.input_telefono.value": function formDefaultDataInput_telefonoValue(newValue, oldValue) {
      var field = this.formSchema.fields.filter(function (x) {
        return x.name == "input_telefono";
      });
      var res = field[0].validation(newValue);
  ...
  methods: {
    onSubmit: function onSubmit(form) {
      ...
      this.formSchema.fields.forEach(function (field) {
        ...
        if (typeof field.comparation == "function" && !_this.formDefaultData[field.name].error.isActive) {
          if (!field.comparation(_this.formDefaultData[field.name].value, _this.formDefaultData[_this.formDefaultData[field.name].toCompare].value)) {
            _this.formDefaultData[field.name].error.isActive = true;
            _this.formDefaultData[field.name].error.message = "Contraseñas no coinciden";
            bandera = false;
          } else {
            _this.formDefaultData[field.name].error.isActive = false;
          }

 ...
 $(document).ready(function() {
    ...
    //EMPIEZAN LAS DE PRUEBA 
    //content.init("testing","1",'{"nombre":"Manuelito","correo":"Manuelito@gmail.com","telefono":"2211620123","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1747","idCaracteristica":"17472","cantidad":"1"} ,{"cp":"72100","idProBodPre":"1748","idCaracteristica":"17473","cantidad":"1"}]}}')
    //content.init("testing","1",'{"nombre":"Manuelito","correo":"Manuelito@gmail.com","telefono":"2211620123","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1747","idCaracteristica":"17472","cantidad":"1"} ,{"cp":"72100","idProBodPre":"1748","idCaracteristica":"17473","cantidad":"1"}]}}')
    ...
    //content.init("testing","1",'{"nombre":"Manuelito","correo":"Manuelito@gmail.com","telefono":"2211620123","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1747","idCaracteristica":"17472","cantidad":"1"}]}}')
    //content.init("testing","1",'{"nombre":"Manuelito","correo":"Manuelito@gmail.com","telefono":"2211620123","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1747","idCaracteristica":"17472","cantidad":"1"},{"cp":"72100","idProBodPre":"1748","idCaracteristica":"17473","cantidad":"1"}]}}')
    //content.init("testing","1",'{"nombre":"Manuelito nava","correo":"manuelito@gmail.com","telefono":"2211620123","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1749","idCaracteristica":"17474","cantidad":"1"}, {"cp":"72100","idProBodPre":"1750","idCaracteristica":"17475","cantidad":"1"}]}}')
    //content.init("testing","1",'{"nombre":"Manuelito nava","correo":"manuelito@gmail.com","telefono":"2211620123","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1749","idCaracteristica":"17474","cantidad":"1"}, {"cp":"72100","idProBodPre":"1750","idCaracteristica":"17475","cantidad":"1"}, {"cp":"72100","idProBodPre":"1749","idCaracteristica":"17474","cantidad":"1"}]}}')
    
    //content.init("testing","1",'{"nombre":"Manuelito","correo":"Manuelito@gmail.com","telefono":"2211620123","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1747","idCaracteristica":"17472","cantidad":"1"},{"cp":"72100","idProBodPre":"1754","idCaracteristica":"17479","cantidad":"1"}]}}')
    
    //content.init("testing","1",'{"nombre":"Manuel","correo":"manu.entony.123@gmail.com","telefono":"2411942580","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1804","idCaracteristica":"17536","cantidad":"1"}]}}')
    //content.init("testing","1",'{"nombre":"Manuel","correo":"manu.entony.123@gmail.com","telefono":"2411942580","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1753","idCaracteristica":"17478","cantidad":"1"},{"cp":"72100","idProBodPre":"1750","idCaracteristica":"17475","cantidad":"1"}]}}')
    //content.init("testing","1",'{"nombre":"Manuel","correo":"manu.entony.123@gmail.com","telefono":"2411942580","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1747","idCaracteristica":"17472","cantidad":"2"},{"cp":"72100","idProBodPre":"1753","idCaracteristica":"17478","cantidad":"1"}]}}')

    //PRUEBAS AGRUPAMIENTO POR PROVEEDOR
    //content.init("testing","1",'{"nombre":"Manuel","correo":"manu.entony.123@gmail.com","telefono":"2411942580","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1753","idCaracteristica":"17478","cantidad":"1"},{"cp":"72100","idProBodPre":"1777","idCaracteristica":"17509","cantidad":"1"}]}}');
content.init("testing","1",'{"nombre":"Manuel","correo":"manu.entony.123@gmail.com","telefono":"2411942580","postal_code":"72100","_cartCollection":{"data":[{"cp":"72100","idProBodPre":"1753","idCaracteristica":"17478","cantidad":"1"},{"cp":"72100","idProBodPre":"1754","idCaracteristica":"17479","cantidad":"1"},{"cp":"72100","idProBodPre":"1777","idCaracteristica":"17509","cantidad":"1"},{"cp":"72100","idProBodPre":"1778","idCaracteristica":"17510","cantidad":"1"}]}}');
});
...
let content = new Vue({
    ...
    methods: {
        ...
        deleteProduct(id) { //Modificado Rodrigo Ruiz
            let tempProducto = [];
            ...
            console.log("Prueba de que almacena tempProducto");
            console.log(tempProducto);
            
            //agregado para cerrar el carrito cuando este vacio
             if (this.productos.length === 0) {
                flag=0;
                let params = "id=" + id +"&flag="+flag; 
                console.log("Enviados a UNITY");
                console.log(params);
        ...
        changeProduct(id){ //incremento en la cantidad de producto
            //enviar id y cantidad
            //var AgregarUltimoProducto = [];
            let cartReference = this;
            cartReference.AgregarUltimoProducto=[]; 

            var arregloProducto= this.productos;  
             
            this.initialize.data._cartCollection.data.forEach(function (producto) { //Recorre los productos en el carrito
                if (producto.idProBodPre === id) {
                    
                    producto.cantidad =  parseInt(producto.cantidad) + 1;

                    // let paramsIncrementAmount= "id=" + id + "&amount="+ producto.cantidad;
                    // comunicateWebView("change-cantidad",p aramsIncrementAmount);
                     
                    //AgregarUltimoProducto.push(parseInt(producto.idProBodPre));

                   arregloProducto.forEach(product => {
                        if (producto.idProBodPre === product.idProBodPre) {
                            //AgregarUltimoProducto.push(product.descripcion);
                            cartReference.AgregarUltimoProducto.push(product.descripcion);

                        }
                    });

                    console.log("Ultimo inmueble alterado");
                    console.log(cartReference.AgregarUltimoProducto);
        ...
        decrementProduct(id){
           this.initialize.data._cartCollection.data.forEach(function (producto) {
               if (producto.idProBodPre === id && producto.cantidad > 1) {
                   producto.cantidad = producto.cantidad >1? parseInt(producto.cantidad) - 1:0;

                //    let paramsIncrementAmount= "id=" + id + "&amount="+ producto.cantidad;
                //     comunicateWebView("change-cantidad",paramsIncrementAmount);
                 
               }
               else{
                //createAviso("El producto no se puede decrementar más, Puede borrarlo pulsando la X");
               }
        ...
        requestProductos() {
            ...
            let service = this.initialize.use_mode == "testing" ? "https://arvispace.com/serviciosASAR/Data_Productos.php" : "https://arvispace.com/serviciosASAR/Data_Productos.php";  
            let tempProductos = [];
        ...
        // requestProveedores(){
        //     let service = this.initialize.use_mode == "testing" ? "https://arvispace.com/serviciosASAR/Get_Proveedor.php" : "https://arvispace.com/serviciosASAR/Get_Proveedor.php";
        //     let tempProductos = []; //arreglo temporal
            
        //     //iteracion sobre la coleccion de productos
        //     this.initialize.data._cartCollection.data.forEach(producto => {
        //         tempProductos.push(parseInt(producto.idProBodPre));
        //     });
        ...
        //     axios.post(service, form).then(function(response) {
        //         //content.proveedores = response.data;
        //         // this.proveedores = response.data;
        //         content.setProveedores(response.data);
        //     }).catch(function(error) {
        ...
        // },
         ...
         // Agrupar productos de acuerdo al proveedor
       
        //Recorrer agrupamiento de productos por proveedor para contactarlo
        groupObjectsByCallBack(objects = array(), callback){
            //Uso de GroupBy
        ...
        requestSuppliers(){
            this.proveedores = content.groupObjectsByCallBack(  
                this.productos, producto => producto.Proveedor.id_proveedor
            ); //el array content.products se agrupa por proveedor a partir del id_proveedor
                //y se guarda en un nuevo array global: proveedores[]
            
            console.log("Proveedores de acuerdo a los productos en el carrito: ", this.proveedores);
        },

        contactSuppliers(){ 
            this.proveedores = content.groupObjectsByCallBack(  
                content.productos,producto => producto.Proveedor.id_proveedor
            ); //el array content.products se agrupa por proveedor a partir del id_proveedor
                //y se guarda en un nuevo array global: proveedores[]

            Object.entries(this.proveedores).forEach(([id_proveedor, productos])=>{
                    const proveedor = productos[0].Proveedor;//todos los productos en el grupo tienen el
                                                            //mismo proveedor

                    const nombreProveedor = proveedor.nombre_completo;
                    const telefono = proveedor.telefono;
                    //Productos
                    const productosPorProveedor = productos.map(p=>p.descripcion);

                    //Contactar a cada proveedor
                    this.contactSupplier(nombreProveedor,telefono,productosPorProveedor);
                });
        },
        
        contactSupplier(supplierName,phoneNumber, products = []){ //Contactar a un solo proveedor
            
            //Mensaje predeterminado
            const defaultMessage = `Hola ${supplierName}, me interesa adquirir los siguientes productos: \n\n- ${products.join('\n- ')}`;
            
            //codificar mensaje
            const encodedMessage = encodeURIComponent(defaultMessage);

            // Abrir en ventana emergente para móviles o nueva pestaña para desktop
        ...
        insertOrder(responseBank, formSubmit, empresaEnvio) { // insercion de pedido 
            ...
            // -----------------comentado para que no se pueda realizar la compra, (descomentar despues para que funcione )---------- la linea de abajo 
        ...
        sessionvalidate() {
            ...
            if (passa == 1) {
                ...
                //Implementación contactar con Proveedores
                //this.requestSuppliers();
        ...
        getPackage()
        {
            ...
            axios.post(service, form).then(async function (response) {
                if (response.status == 200) {
                    ...
                    console.log(this.productosPaquetes);
                    console.log("Peso total: " + pesoTotal);
                    console.log("Altura total: " + alturaGlobal);
                    cartReference.datosEnvio[0] = pesoTotal;
                    cartReference.datosEmpaquetado[2]= alturaGlobal;


                    /*this.productosPaquetes.forEach(productosPaquete =>{
                        cartCollectionData.forEach(producto=>{
                            if (producto.idProBodPre == productoPaquete.idProBodPre) {
                                cantidadDeProducto = producto.cantidad;
                            }
        ...
        consultarCotizacion(){
            ...
            const packageData = {
                ...
                package: { 
                    ...
                    height: this.datosEmpaquetado[2],
            ...
            .then((response) => {
                ...
                var productosobrepesado= this.AgregarUltimoProducto;
               
                let tempProducto = [];
                console.log('RESPUESTA QUATATION');
                console.log(data);

                     console.log('Tamño');
                    console.log(data.data.rates.length);


                    if (data.data.rates.length===0){
                        console.log('NO HAY PAQUETERIAS DISPONIBLES' +cartReference.AgregarUltimoProducto);
                        //createAviso("NO HAY PAQUETERIAS DISPONIBLES " +cartReference.AgregarUltimoProducto ) ;
                        
                    console.log("Ultimo elemento");
                    console.log(cartReference.AgregarUltimoProducto); // Imprime el último producto en el arreglo


                        //alert("No se encontraron paqueterias disponibles!!");
                       // createAviso("No se encontraron paqueterias en su zona debido al tamaño del paquete, disminuya la cantidad de productos e intentelo de nuevo" +cartReference.AgregarUltimoProducto);
                       

                    }else{
                        
                        console.log('SI SE ENCONTRARON PAQUETERIAS');
                        
                        console.log("Ultimo elemento en el arreglo");
                        console.log(cartReference.AgregarUltimoProducto); // Imprime el último producto en el arreglo
                ...
                console.log('REPUESTA ALMACENADA');
                console.log(cartReference.datosEnvio[1]);
                ...
                let envioDatos =  {
                        ...
                        Paquete: 
                        {
                            ...
                            Largo:this.datosEmpaquetado[0],
                            //Alto: this.cajaEnvio.Alto,
                            Alto:this.datosEmpaquetado[2],
                            //Ancho: this.cajaEnvio.Ancho
                            Ancho: this.datosEmpaquetado[1]
                ...
                var stored = localStorage['DatosPaquete'];
                console.log('LOCALSTORAGE DatosPaquete  ');
                console.log(stored); //PRUEBA RESPUESTA DEL LOCALSTORAGE
                console.log(window.envioDatosBackup);
                if (stored) {
                    myVar = JSON.parse(stored);
            ...
            .catch((error) => {
                ...
                createAviso("El paquete supera las dimensiones o peso maximas permitidas en cualquier paqueteria, por favor disminuya la cantidad de articulos '"+cartReference.AgregarUltimoProducto+ "' e intentelo de nuevo. ");
            });
        },
